...
class SearchInputComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CTextInput(
      ...
      enableInput: false,
      height: 10,
      inputBackgroundColors: ColorUtils.backgroundColors,
      filled: true,
      focusBorderColors: ColorUtils.borderSearchColors.withOpacity(0.17),
      enableBorderColors: ColorUtils.borderSearchColors.withOpacity(0.17),
      labelInput: "label",
      hintText: "label",
